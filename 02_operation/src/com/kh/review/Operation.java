...
//		increase();
	...
	private static void increase() {
		/*
		 * 증감 연산자(단항연산자) ++ : 변수에 담긴 값을 1씩 증가시켜주는 연산자 ex) ++변수 / 변수 ++ __ : 변수에 담긴 값을 1씩
		 * 감소시켜주는 연산자 ex)변수--/ --변수
		 * 
		 * 증감연산자 외에 다른 연산자도 있을 경우 전위연산 : 증감연산자를 먼저 처리한 후에 다른 연산자를 수행 (증감연산자) 변수 : 선 증감
		 * 후처리 후위연산 : 다른 연산을 먼저 수행한 후 증감연산자를 수행 변수(증감연산자): 선처리 후증감
		 * 
		 */
		...
		System.out.println("1회 수행 결과" + n2++); // 11
		System.out.println("2회 수행 결과" + n2++); // 12
	...
	private static void tripple() {
		/*
		 * 삼항연산자 : 조건문 (if)와 유사한 연산자 [표현식] 조건식 ? 조건식의 결과가 참인 경우 사용될 값 : 조건식의 결과가 거짓인 경우
		 * 사용
		 * 
